...
export type GetVideoTypesQuery = {
  __typename?: 'Query';
  videoTypes: Array<{ __typename?: 'VideoType'; id: string; name: string; sortOrder: number }>;
};
...
export const GetVideoTypesDocument = {
  kind: 'Document',
  definitions: [
    {
      kind: 'OperationDefinition',
      ...
      selectionSet: {
        ...
        selections: [
          {
            kind: 'Field',
            name: { kind: 'Name', value: 'videoTypes' },
            selectionSet: {
              kind: 'SelectionSet',
              selections: [
                { kind: 'Field', name: { kind: 'Name', value: 'id' } },
...
} as unknown as DocumentNode<GetVideoTypesQuery, GetVideoTypesQueryVariables>;
