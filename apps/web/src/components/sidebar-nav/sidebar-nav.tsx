...
const DocsSidebarNav = ({ items }: DocsSidebarNavProps) => {
...
const DocsSidebarNavItems = ({ items, pathname }: DocsSidebarNavItemsProps) => {
  return items?.length ? (
...
export { DocsSidebarNav, DocsSidebarNavItems };
